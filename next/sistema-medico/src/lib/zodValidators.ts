...
const recepcionistaSchemaArray = z.array(recepcionistaSchema);
...
type Recepcionista = z.infer<typeof recepcionistaSchema>;

export type { Agendamento, Medico, Paciente, Recepcionista };
